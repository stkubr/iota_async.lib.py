...
from iota_async import BundleHash, Tag, TransactionHash
from iota_async.commands import FilterCommand, RequestFilter, ResponseFilter
from iota_async.filters import AddressNoChecksum, Trytes
...
class FindTransactionsCommand(FilterCommand):
    ...
    See :py:meth:`iota_async.api.StrictIota.find_transactions`.
    """
