...
from iota_async import BadApiResponse, Bundle, BundleHash, Transaction, \
    TransactionHash, TryteString
from iota_async.commands import FilterCommand, RequestFilter
from iota_async.commands.core.get_trytes import GetTrytesCommand
from iota_async.exceptions import with_context
from iota_async.filters import Trytes
from iota_async.transaction.validator import BundleValidator
...
class GetBundlesCommand(FilterCommand):
    ...
    See :py:meth:`iota_async.api.Iota.get_bundles` for more info.
    """
    command = 'getBundles'
