...
from iota_async.commands.extended import GetLatestInclusionCommand
from iota_async.commands.extended.utils import find_transaction_objects
...
class IsReattachableCommand(FilterCommand):
    ...
    async def _execute(self, request):
        ...
        transactions = await find_transaction_objects(
