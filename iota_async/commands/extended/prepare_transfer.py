...
from iota_async import Address, BadApiResponse, ProposedBundle, \
    ProposedTransaction
...
from iota_async.commands.extended.get_inputs import GetInputsCommand
from iota_async.commands.extended.get_new_addresses import GetNewAddressesCommand
...
from iota_async.filters import GeneratedAddress, SecurityLevel, Trytes
...
class PrepareTransferCommand(FilterCommand):
    ...
    See :py:meth:`iota_async.api.Iota.prepare_transfer` for more info.
    """
