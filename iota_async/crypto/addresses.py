...
from iota_async import Address, TRITS_PER_TRYTE, TrytesCompatible
from iota_async.crypto.kerl import Kerl
from iota_async.crypto.signing import KeyGenerator, KeyIterator
...
class AddressGenerator(Iterable[Address]):
    ...
    :py:meth:`iota_async.api.IotaApi.get_new_addresses` instead.

    Note also that :py:meth:`iota_async.api.IotaApi.get_new_addresses` uses
    ...
    - :py:meth:`iota_async.transaction.ProposedBundle.sign_inputs`
    - :py:class:`iota_async.transaction.BundleValidator`
    """
