...
from iota_async import Address, Iota, ProposedTransaction
from iota_async.commands import discover_commands
from iota_async.crypto.addresses import AddressGenerator
from iota_async.crypto.types import Digest
from iota_async.multisig import commands
...
class MultisigIota(Iota):
    ...
    """
    commands = discover_commands('iota_async.multisig.commands')
    ...
    def get_private_keys(
        ...
        - :py:class:`iota_async.crypto.signing.KeyGenerator`
    ...
    def prepare_multisig_transfer(
        ...
        .. note::
            ...
            require inputs), use
            :py:meth:`iota_async.api.Iota.prepare_transfer` instead.
        ...
        :param transfers:
            ...
            .. important::
                ...
                :py:meth:`iota_async.api.prepare_transfer` instead.
        ...
        :param multisig_input:
            ...
            .. note::
                ...
                :py:class:`iota_async.multisig.transaction.ProposedMultisigBundle`
                object manually.
        ...
        :param change_address:
            ...
            .. important::
                Unlike :py:meth:`iota_async.api.Iota.prepare_transfer`, this
        ...
        :return:
          ...
          the :py:meth:`iota_async.crypto.types.PrivateKey.sign_input_at`
          ...
          using :py:meth:`iota_async.api.Iota.send_trytes`.
        """
