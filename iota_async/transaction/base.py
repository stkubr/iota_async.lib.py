...
from iota_async.codecs import TrytesDecodeError
from iota_async.crypto import Curl, HASH_LENGTH
from iota_async.json import JsonSerializable
from iota_async.transaction.types import BundleHash, Fragment, Nonce, \
    TransactionHash, TransactionTrytes
from iota_async.trits import int_from_trits, trits_from_int
from iota_async.types import Address, Tag, TryteString, TrytesCompatible
...
class Transaction(JsonSerializable):
    ...
    def __init__(
        ...
        - :py:meth:`iota_async.api.StrictIota.get_inclusion_states`
        - :py:meth:`iota_async.api.Iota.get_transfers`
        """
...
class Bundle(JsonSerializable, Sequence[Transaction]):
    ...
    - :py:class:`iota_async.commands.extended.get_bundles.GetBundlesCommand`
    """
    ...
    def __init__(self, transactions=None):
        ...
        - :py:class:`iota_async.commands.extended.get_transfers.GetTransfersCommand`
        """
