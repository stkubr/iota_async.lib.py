...
from iota_async.crypto import HASH_LENGTH
from iota_async.crypto.kerl import Kerl
from iota_async.crypto.signing import KeyGenerator, normalize
from iota_async.crypto.types import PrivateKey
from iota_async.exceptions import with_context
from iota_async.transaction.base import Bundle, Transaction
from iota_async.transaction.types import BundleHash, Fragment, Nonce, TransactionHash
from iota_async.transaction.utils import get_current_timestamp
from iota_async.trits import add_trits
from iota_async.types import Address, Tag, TryteString
...
class ProposedTransaction(Transaction):
    ...
    Provide to :py:meth:`iota_async.api.Iota.send_transfer` to attach to
...
class ProposedBundle(Bundle, Sequence[ProposedTransaction]):
    ...
    def as_json_compatible(self):
        ...
        - :py:class:`iota_async.json.JsonEncoder`.
        """
