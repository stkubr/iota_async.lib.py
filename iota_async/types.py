...
from iota_async import AsciiTrytesCodec, TRITS_PER_TRYTE
...
from iota_async.json import JsonSerializable
from iota_async.trits import int_from_trits, trits_from_int
...
class TryteString(JsonSerializable):
    ...
    def encode(self, errors='strict', codec=AsciiTrytesCodec.name):
        ...
        :raise:
            - :py:class:`iota_async.codecs.TrytesDecodeError` if the trytes
